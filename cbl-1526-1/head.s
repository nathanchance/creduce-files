...
# 356 "<built-in>" 2
# 1 "arch/mips/kernel/head.S" 2
# 16 "arch/mips/kernel/head.S"
...
# 17 "arch/mips/kernel/head.S" 2
# 1 "./include/linux/threads.h" 1
# 18 "arch/mips/kernel/head.S" 2
...
# 20 "arch/mips/kernel/head.S" 2

# 1 "./arch/mips/include/asm/asmmacro.h" 1
# 12 "./arch/mips/include/asm/asmmacro.h"
...
# 518 "./arch/mips/include/asm/asmmacro.h"
 ...
 .set pop
 .endm
# 22 "arch/mips/kernel/head.S" 2
# 1 "./arch/mips/include/asm/irqflags.h" 1
# 23 "arch/mips/kernel/head.S" 2


# 1 "./arch/mips/include/asm/stackframe.h" 1
# 19 "./arch/mips/include/asm/stackframe.h"
# 1 "./arch/mips/include/asm/asm-offsets.h" 1
...
# 28 "arch/mips/kernel/head.S" 2
 ...
 .set push
 mfc0 $12, $12
 or $12, (0x10000000 | 0x40000000)|\set|0x1f|\clr
 xor $12, 0x1f|\clr
 mtc0 $12, $12
 .set noreorder
 sll $0,3 # ehb
 ...
 setup_c0_status 0x00000080 0x00400000



 .endm
# 70 "arch/mips/kernel/head.S"
.globl _stext; _stext:
# 82 "arch/mips/kernel/head.S"
 .section ".ref.text", "ax"

.cfi_sections .debug_frame; .globl kernel_entry; .align 2; .type kernel_entry, @function; .ent kernel_entry, 0; kernel_entry: .frame $29, 16, $29; .cfi_startproc; .insn # kernel entry point
...
1:
 ...
 sd $4, fw_arg0 # firmware arguments
 sd $5, fw_arg1
 sd $6, fw_arg2
 sd $7, fw_arg3

 dmtc0 $0, $4 # clear context register

 dmtc0 $0, $20

 dla $28, init_thread_union

 dli $29, 16384 - 32 - 304
 daddu $29, $28

 set_saved_sp $29, $12, $13
 dsubu $29, 4 * 8 # init stack pointer
# 140 "arch/mips/kernel/head.S"
 j start_kernel

 .cfi_endproc; .end kernel_entry; .size kernel_entry, .-kernel_entry
...
.cfi_sections .debug_frame; .globl smp_bootstrap; .align 2; .type smp_bootstrap, @function; .ent smp_bootstrap, 0; smp_bootstrap: .frame $29, 16, $29; .cfi_startproc; .insn
 smp_slave_setup
 setup_c0_status_sec
 j start_secondary
 .cfi_endproc; .end smp_bootstrap; .size smp_bootstrap, .-smp_bootstrap
